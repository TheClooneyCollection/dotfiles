...
#+BEGIN_SRC emacs-lisp
  (use-package spacemacs-common           ; hack to get spacemacs-themes loading...
    ...
    :config (load-theme 'spacemacs-light t)) ;TODO
#+END_SRC
** powerline
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package hl-todo
    :config
    (general-define-key "stn" 'hl-todo-next)
    (general-define-key "stp" 'hl-todo-previous)
    (general-define-key "sto" 'hl-todo-occur)
    (global-hl-todo-mode))
#+END_SRC
* time
#+BEGIN_SRC emacs-lisp
