...
** gtags
   ...
   #+BEGIN_SRC emacs-lisp :results output
     ...
     (add-hook 'swift-mode #'(lambda ()
                              (progn
                                (ggtags-mode)
                                (define-key evil-normal-state-map (kbd "<return>") 'helm-gtags-find-tag)
                                (define-key evil-normal-state-map (kbd "<C-return>") 'helm-gtags-find-symbol))))
   #+END_SRC
...
** helm-gtags
   ...
   #+BEGIN_SRC emacs-lisp :results output
     ...
     (spacemacs/helm-gtags-define-keys-for-mode 'org-mode)
   #+END_SRC
